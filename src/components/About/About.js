  ...
  return (
    ...
    <div className="About">
        ...
        <div>
          ...
          <p>I am a passionate computer science student who strives to create intuitive and visually appealing websites and web apps. I am dedicated to continuous learning and improving my skills in front-end development.</p>
